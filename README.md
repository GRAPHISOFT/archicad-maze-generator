...
!!! Disclaimer: Please note that this example targets Development Kits for Archicad versions 25-29. Check out the [official Add-On template](https://github.com/GRAPHISOFT/archicad-addon-cmake) repository for a detailed build guide.